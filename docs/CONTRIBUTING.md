...
| Push `v*` tag | GitHub Actions | Full CI, then GitHub Release publication |
...
| `release` (Publish GitHub Release) | Validates the SemVer tag and publishes generated release notes. Pre-release tags are marked accordingly. |
