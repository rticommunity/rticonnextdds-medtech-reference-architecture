...
*Note, the **Forged Permissions** and **Expired Certificate** attack modes require the trusted system CA private key located at `system_arch/security/ca/private/CaPrivateKey.pem`. This key is generated by `setup_security.py` and is used only for laboratory demonstration of how certificate chains can be abused. Keep it secure in any real deployment.*
...
python3 scripts/launch_injector.py

# OR launch the Threat Exfiltrator:
python3 scripts/launch_exfiltrator.py
```
